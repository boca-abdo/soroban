...
<div class="row no-gutters h-100 justify-content-center p-0 pt-5">
  <div class="col-12 align-self-top">
    <div class="container text-center">
      ...
      <h2 class="h2 animated pulse infinite">The english version of soroban website is upgrading, you can still check the arab version <a href="../ar/index.php">here</a></h2>
  ...
  <div class="w-100 align-self-end font-weight-bold text-center mt-5">
    ...
    <p class="text-uppercase m-0" dir="ltr">designed by <a href="http://aws.skwila.net" target="_blank" class="text-dark"><i>aws</i></a> - <a href="../../terms.php"><i>Privacy</i></a></p>
  </div>
</body>
</html>
