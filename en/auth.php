		              ...
		              <fieldset class="form-group row justify-content-center">
						...
						<div class="row justify-content-center align-items-center px-3">
							...
							<div class="col-sm-6 col-md-4 my-2">
								<button type="button" class="btn btn-outline-warning btn-block rounded-0 text-uppercase" id="fb" style="box-shadow:none">facebook<i class="fab fa-facebook-square ml-2"></i></button>
							</div>
							<div class="col-sm-6 col-md-4 my-2">
								<button type="button" class="btn btn-outline-warning btn-block rounded-0 text-uppercase" id="ggl" style="box-shadow:none">google<i class="fab fa-google ml-2"></i></button>
							</div>
						...
						$.ajax({
							...
							success: function(res) {
								if (res === "done") {
									...
									$("#scl").text("error, please try again");
									console.log(res);
								}
							},
