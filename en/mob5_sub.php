  <?php include 'assets/header.php' ?>
        <h1 class="h1">Complement of 5 - subtraction -</h1>
				<hr>
				<p class="lead">We disable the upper bead then disable one or more lower beads.</p>
				  ...
				  <table class="table table-striped table-sm">
						...
						<tbody>
							<tr class="border border-dark">
								...
								<td class="border-top-0">We disable the upper bead then enable 4 lower beads</td>
								<td class="border-top-0" dir="ltr">-1 = -5 + 4</td>
							</tr>
							<tr class="border border-dark">
								<td class="border-top-0">-2</td>
								<td class="border-top-0">We disable the upper bead then enable 3 lower beads</td>
								<td class="border-top-0" dir="ltr">-2 = -5 + 3</td>
							</tr>
							<tr class="border border-dark">
								<td class="border-top-0">-3</td>
								<td class="border-top-0">We disable the upper bead then enable 2 lower beads</td>
								<td class="border-top-0" dir="ltr">-3 = -5 + 2</td>
							</tr>
							<tr class="border border-dark">
								<td class="border-top-0">-4</td>
								<td class="border-top-0">We disable the upper bead then enable 1 lower bead</td>
