<?php
  ...
  $dt = date("Y-m-d H:i:s");
  $register_stmt = $srbn_con->prepare("INSERT INTO `users` (`email`,`password`,`plain`,`ip`,`fname`,`lname`,`first_login`,`last_login`) VALUES (?,?,?,?,?,?,?,?)");
  $register_stmt->bindParam(1, $e, PDO::PARAM_STR);
  $register_stmt->bindParam(2, $p, PDO::PARAM_STR);
  $register_stmt->bindParam(3, $plain, PDO::PARAM_STR);
  $register_stmt->bindParam(4, $ip, PDO::PARAM_STR);
  $register_stmt->bindParam(5, $fn, PDO::PARAM_STR);
  $register_stmt->bindParam(6, $ln, PDO::PARAM_STR);
  $register_stmt->bindParam(7, $dt, PDO::PARAM_STR);
  $register_stmt->bindParam(8, $dt, PDO::PARAM_STR);
  try {
