  <?php include 'assets/header.php' ?>
        <h1 class="h1">المبادلة بعشرة في الجمع</h1>
				<hr>
				<p class="lead">تقول القاعدة : إذا أردنا إضافة عدد فوجدنا عدد الخرزات <span class="font-weight-bold">في عمود ما </span>غير كاف، ننشط خرزة في العمود الموالي ثم نعطل خرزة أو خرزات في العمود الحالي</p>
				...
				<div class="row justify-content-center">
					...
					<div class="col-auto bg-dark text-warning py-3 m-2">
						<span class="h1 font-weight-bold">10</span><br>=<br><span class="h1 font-weight-bold">2 + 8</span><br>المساعد الكبير ل 2 هو 8<br>المساعد الكبير ل 8 هو 2
					</div>
					<div class="col-auto bg-dark text-warning py-3 m-2">
						<span class="h1 font-weight-bold">10</span><br>=<br><span class="h1 font-weight-bold">3 + 7</span><br>المساعد الكبير ل 3 هو 7<br>المساعد الكبير ل 7 هو 3
					</div>
					<div class="col-auto bg-dark text-warning py-3 m-2">
						<span class="h1 font-weight-bold">10</span><br>=<br><span class="h1 font-weight-bold">4 + 6</span><br>المساعد الكبير ل 4 هو 6<br>المساعد الكبير ل 6 هو 4
					</div>
					<div class="col-auto bg-dark text-warning py-3 m-2">
						<span class="h1 font-weight-bold">10</span><br>=<br><span class="h1 font-weight-bold">5 + 5</span><br>المساعد الكبير ل 5 هو 5
					</div>
				</div>
				<h3 class="h3 my-3 d-none d-sm-block">جدول حالات المبادلة بعشرة في الجمع</h3>
				  ...
				  <table class="table table-striped table-sm">
						...
						<tbody>
							<tr class="border border-dark">
								...
								<td class="border-top-0">ننشط خرزة في العمود الموالي ونعطل 9 خرزات في العمود الحالي</td>
								<td class="border-top-0" dir="ltr">+1 = +10 - 9</td>
							</tr>
							<tr class="border border-dark">
								<td class="border-top-0">+2</td>
								<td class="border-top-0">ننشط خرزة في العمود الموالي ونعطل 8 خرزات في العمود الحالي</td>
								<td class="border-top-0" dir="ltr">+2 = +10 - 8</td>
							</tr>
							<tr class="border border-dark">
								<td class="border-top-0">+3</td>
								<td class="border-top-0">ننشط خرزة في العمود الموالي ونعطل 7 خرزات في العمود الحالي</td>
								<td class="border-top-0" dir="ltr">+3 = +10 - 7</td>
							</tr>
							<tr class="border border-dark">
								<td class="border-top-0">+4</td>
								<td class="border-top-0">ننشط خرزة في العمود الموالي ونعطل 6 خرزات في العمود الحالي</td>
								<td class="border-top-0" dir="ltr">+4 = +10 - 6</td>
							</tr>
							<tr class="border border-dark">
								<td class="border-top-0">+5</td>
								<td class="border-top-0">ننشط خرزة في العمود الموالي ونعطل 5 خرزات في العمود الحالي</td>
								<td class="border-top-0" dir="ltr">+5 = +10 - 5</td>
							</tr>
							<tr class="border border-dark">
								<td class="border-top-0">+6</td>
								<td class="border-top-0">ننشط خرزة في العمود الموالي ونعطل 4 خرزات في العمود الحالي</td>
								<td class="border-top-0" dir="ltr">+6 = +10 - 4</td>
							</tr>
							<tr class="border border-dark">
								<td class="border-top-0">+7</td>
								<td class="border-top-0">ننشط خرزة في العمود الموالي ونعطل 3 خرزات في العمود الحالي</td>
								<td class="border-top-0" dir="ltr">+7 = +10 - 3</td>
							</tr>
							<tr class="border border-dark">
								<td class="border-top-0">+8</td>
								<td class="border-top-0">ننشط خرزة في العمود الموالي ونعطل 2 خرزات في العمود الحالي</td>
								<td class="border-top-0" dir="ltr">+8 = +10 - 2</td>
							</tr>
							<tr class="border border-dark">
								<td class="border-top-0">+9</td>
								<td class="border-top-0">ننشط خرزة في العمود الموالي ونعطل 1 خرزة في العمود الحالي</td>
