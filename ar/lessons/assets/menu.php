<div class="navbar fixed-top justify-content-between bg-dark p-0">
  ...
  <div class="dropdown open">
    ...
    <div class="dropdown-menu bg-dark rounded-0 text-center p-0" aria-labelledby="dropdownMenu1" style="left: -120px">
      ...
      <a class="dropdown-item" href="simple_mul.php">الضرب البسيط</a>
      <a class="dropdown-item" href="comp_mul.php">الضرب المركب</a>
