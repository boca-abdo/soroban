        ...
        if (res == answer) {
          face = "smile";
	        ...
	        face = "frown";
				...
				$("#tv").append("<div class='table-responsive w-75 pt-3 mx-auto'><table class='table table-sm table-bordered border-dark'><tr><td class='border-dark'>اﻹجابة</td><td class='border-dark'>الصحيح</td></tr><tr><td class='border-dark'>"+answer+"</td><td class='border-dark'>"+res+"</td></tr></table></div><i class='far fa-5x fa-"+face+" animated zoomIn'></i>");
				if (correct === 0) {
					nextLevel();
				} else {
					setTimeout(function(){
